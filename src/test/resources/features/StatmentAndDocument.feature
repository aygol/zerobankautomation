...
Feature: Statements and Documents
  As user, I should be able to view my statements and documents year in pdf format

  Background:  Log in and navigate to statements and documents tab
    Given user is on login page
    Then user enters credentials
    When user navigates to "Online Statements" tab
