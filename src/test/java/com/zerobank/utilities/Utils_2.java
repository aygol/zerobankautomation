...
public class Utils_2 {
     ...
     * @return
     */
    public static List<Integer> convertListtoInteger(List<WebElement> listWeb){
    ...
    public static boolean isFileDownloaded(String fileName) {
        File dir = new File(ConfigurationReader.getProperty("download_path"));
    ...
    public static String verifyFileExtension(String type) {
        File dir = new File(ConfigurationReader.getProperty("download_path"));
        File[] dir_contents = dir.listFiles();
        for (int i = 0; i < Objects.requireNonNull(dir_contents).length; i++) {
            if (dir_contents[i].getName().endsWith(type)) {
                return type;
            }
        }
